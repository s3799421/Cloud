...
<center><h2>Welcome <?php echo $_POST["username"]; ?></h2></center> <br>
        <center><p>Change Password</p></center>
        

<form>

<center><p> Old Password: <font color=red>*</font><input type="text" name="old password" autocomplete="off" required></p></center><br>
<center><p> New Password: <font color=red>*</font><input type="text" name="new password" autocomplete="off" required></p></center><br>
