...
<center><h2>Welcome</h2></center> <br>
        <center><p>Are you a Donor Or Recipient?</p></center>
        <p><center>
        <a href="donor.php" class="w3-button w3-xlarge w3-theme w3-hover-teal" font= "14px sans-serif">Donor</a>
        <a href="recipient.php" class="w3-button w3-xlarge w3-theme w3-hover-teal" font= "14px sans-serif">Recipient</a>
    </center></p>
  </div>
