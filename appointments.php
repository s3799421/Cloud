...
<center><h2>Appointments</h2></center> <br>
        
        <p><center>
        <a href="newDappointments.php" class="w3-button w3-xlarge w3-theme w3-hover-teal" font= "14px sans-serif">Add Donor Appointment</a>
        <a href="newRappointments.php" class="w3-button w3-xlarge w3-theme w3-hover-teal" font= "14px sans-serif">Add Recipient Appointment</a>
    </center></p><br>
		<p><center>
        <a href="donorappointments.php" class="w3-button w3-xlarge w3-theme w3-hover-teal" font= "14px sans-serif">See Donor Appointments</a>
        <a href="recipientappointments.php" class="w3-button w3-xlarge w3-theme w3-hover-teal" font= "14px sans-serif">See Recipient Appointments</a>
    </center></p>
  </div>
