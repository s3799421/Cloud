...
if(mysqli_query($db, $sql)){
    echo '<a href="recipient.php">Donor Appointment added successfuly.</a>';
} else{
...
<div class="w3-display-container w3-animate-opacity">
  <img src="https://bbspictures.s3-ap-southeast-2.amazonaws.com/blood3a.jpg" alt="boat" style="width:100%;min-height:350px;max-height:600px;">
